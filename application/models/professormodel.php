...
class Professormodel extends CI_Model {
	...
	public function listar()
	{
		...
		$this->db->join('pessoa', 'professor.pes_codigo = pessoa.pes_codigo', 'inner');

		$r = $this->db->get('professor');
	...
	public function busca_editar($pes_codigo)
	{
		...
		$this->db->join('pessoa', 'pessoa.pes_codigo = professor.pes_codigo', 'inner');
	...
	public function deletar($pes_codigo)
	{
		...
		$this->db->delete('professor', $pessoa); 
