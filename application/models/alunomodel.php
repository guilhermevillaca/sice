...
class Alunomodel extends CI_Model {
	...
	public function listar()
	{
		...
		$this->db->join('pessoa', 'aluno.pes_codigo = pessoa.pes_codigo', 'inner');
	...
	public function busca_editar($pes_codigo)
	{
		...
		$this->db->join('pessoa', 'pessoa.pes_codigo = aluno.pes_codigo', 'inner');
	...
	public function editar()
	{
		...
		$this->db->where('pes_codigo', $this->input->post('pes_codigo'));
